...
const EditProfile = () => {
            ...
            axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/get-profile", { username: userAuth.username })
                .then(({ data }) => {
                    ...
                    if (data.user.social_links) {
                        user.social_links = { ...profileStructure.social_links, ...data.user.social_links }
                    }
                    setProfile(user);
                    setLoading(false);
                })
    ...
    const handleSubmit = (e) => {
        ...
        if (bio.length > 150) {
            return toast.error("Bio should not be more than 150 characters");
        }
                    ...
                    <form ref={editProfileForm}>
                        ...
                        <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                            ...
                            <div className="w-full">
                                ...
                                <textarea name="bio" maxLength={150} defaultValue={bio} className="input-box h-64 lg:h-40 resize-none leading-7 mt-5 pl-5" placeholder="Bio" onChange={handleCharacterChange}></textarea>

                                <p className="mt-1 text-dark-grey">150 characters left</p>
                                ...
                                <button className="btn-dark w-px-10" type="submit" onClick={handleSubmit}>Update</button>
