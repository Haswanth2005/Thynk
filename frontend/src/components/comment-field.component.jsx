        ...
        axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/add-comment", {
            ...
            .then(({ data }) => {
                ...
                if (replyingTo) {
                    ...
                    comments[index].children.push(data._id)

                    data.childrenLevel = comments[index].childrenLevel + 1;
                    data.parentIndex = index;

                    comments[index].isReplyLoaded = true;

                    comments.splice(index + 1, 0, data);
                    ...
                    newCommentArr = [data, ...comments];
                }

                let parentCommentIncrementval = replyingTo ? 0 : 1;

                setBlog({ ...blog, comments: newCommentArr, activity: { ...activity, total_comments: total_comments + 1, total_parent_comments: total_parent_comments + parentCommentIncrementval } })
